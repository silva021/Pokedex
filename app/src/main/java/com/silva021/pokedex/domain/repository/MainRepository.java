...
import com.silva021.pokedex.data.api.PokemonService;
...
public class MainRepository {
    ...
    public LiveData<List<Pokemon>> getAllPokemon(int page) {
        ...
        ServiceGenerator.createService(PokemonService.class).getAllPokemon(page).enqueue(new Callback<List<Pokemon>>() {
            @Override
